...
import { ArrowLeft, ShieldCheck, Scale, Globe, RefreshCw, Mail } from 'lucide-react';
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-[var(--primary-50)] p-3 rounded-full">
                  <ShieldCheck className="w-8 h-8 text-[var(--primary-600)]" />
                </div>
                ...
                {t('gdpr.sections', { returnObjects: true }).map((section: any, index: number) => (
                  <div key={index} className="mb-12 last:mb-0">
                    <div className="flex items-center gap-3 mb-4">
                      {index === 0 && <Scale className="w-6 h-6 text-[var(--primary-600)]" />}
                      {index === 1 && <ShieldCheck className="w-6 h-6 text-[var(--primary-600)]" />}
                      {index === 2 && <Globe className="w-6 h-6 text-[var(--primary-600)]" />}
                      {index === 3 && <Mail className="w-6 h-6 text-[var(--primary-600)]" />}
              ...
              <div className="mt-12 pt-8 border-t border-gray-100">
                <div className="flex items-start gap-4 bg-[var(--primary-50)] rounded-xl p-6">
                  <div className="bg-white p-3 rounded-full shrink-0">
                    <Mail className="w-6 h-6 text-[var(--primary-600)]" />
                  </div>
                  <div>
                    ...
                    <p className="text-[var(--primary-600)]">
                      ...
                      contactez notre Délégué à la Protection des Données à dpo@auto-eco-expert.fr
                    </p>
                  </div>
                </div>
              </div>
