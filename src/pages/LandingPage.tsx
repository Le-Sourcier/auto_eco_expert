...
const mockReviews = [
  {
    ...
    rating: 5,
    comment:
      "Service exceptionnel ! J'ai économisé plus de 4000€ sur ma nouvelle voiture grâce à leurs conseils avisés.",
    name: "Thomas D.",
    date: "15 février 2024",
    likes: 12,
    adminResponse:
      "Merci Thomas pour votre confiance ! Nous sommes ravis d'avoir pu vous aider à réaliser ces économies substantielles.",
  },
  {
    id: "2",
    rating: 5,
    comment:
      "L'IA a vraiment fait la différence dans ma recherche. Les recommandations étaient parfaitement adaptées à mes besoins.",
    name: "Sophie M.",
...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <Chatbot onOpen={handleStartChat} />
    </>
  );
};
