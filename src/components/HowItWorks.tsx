      ...
      <div className="container-custom relative">
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              <div className={`absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full flex items-center justify-center bg-[var(--${step.color}-600)] text-white shadow-lg`}>
                <step.icon size={32} />
              </div>
